...
import net.itsrelizc.commands.PlayAllCommands;
...
public class Main extends JavaPlugin implements Listener {
	...
	public void onEnable() {
		...
		this.getCommand("lol").setExecutor(new PlayAllCommands());
...
//		this.getCommand("votesong").setExecutor(new SongVoteMenuCommand());
	...
	public void playerJoinEvent(PlayerJoinEvent event) {
		ChatUtils.systemMessage(event.getPlayer(), "§a§lLIFESTEAL", "§eWelcome to lifesteal SMP! §7(Version 1.5.0)");
		ChatUtils.systemMessage(event.getPlayer(), "§a§lLIFESTEAL", "§aThis map will be archived after this season is over! §7(Current Season: April 2023)"); // §d§lLIFESTEAL
