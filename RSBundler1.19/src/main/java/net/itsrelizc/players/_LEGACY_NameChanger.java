...
// * http://shawckz.com
// */
//public class _LEGACY_NameChanger {
//
//    /*
//    a = (String)name
...
//     * @param color
//     */
//    public _LEGACY_NameChanger(String teamName, String displayName, NameTagColor color){
...
//     * @param suffix
//     */
//    public _LEGACY_NameChanger(String teamName, String displayName, String prefix, String suffix){
//        packet = new PacketPlayOutScoreboardTeam();
//        setField("h",0);
//        setField("b",displayName);
//        setField("a",teamName);
...
//     * @param prefix
//     */
//    public _LEGACY_NameChanger(String teamName, String displayName, String prefix){
//        packet = new PacketPlayOutScoreboardTeam();
//        setField("h",0);
//        setField("b",displayName);
//        setField("a",teamName);
